...
def main():
    try:
        ...
        video_socket.bind(('your_raspberry_pi_ip address', 5000) #change your raspberry pi ip address that connect in ethernet
        video_socket.listen(1)

        # Set up the server socket for commands
        command_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
        command_socket.bind(('your_raspberry_pi_ip address', 5001)) #change your raspberry pi ip address that connect in ethernet
